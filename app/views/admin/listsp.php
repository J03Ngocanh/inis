...
<div class="detail">
    ...
    <!-- Nút mở popup -->
    <button class="add-btn" onclick="window.location.href='/inis/admin/add'">Thêm sản phẩm</button>
    <!-- Modal (Popup) -->
    <div id="productModal" class="modal">
        <div class="modal-content">
            <span class="close" onclick="closeModal()">&times;</span>
            <h2>Thêm sản phẩm mới</h2>
            <form method="POST" enctype="multipart/form-data" action="/inis/admin/xulythemsanpham"
        ...
        <?php while ($row = mysqli_fetch_array($listsp)): ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="/inis/admin/xoasp/<?php echo $row['masanpham']; ?>"
                       onclick="return confirmCustom('Bạn chắc chắn muốn xóa sản phẩm này?')">
