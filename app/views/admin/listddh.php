                ...
                <tr>
                    ...
                    <td>
                        <?php if ($row['trangthai'] == "new") { ?>
                            <a href="/inis/admin/xulyxacnhan/<?php echo $row['mahoadon'] ?>"
                               id="confirm-link-<?php echo $row['mahoadon'] ?>">
                                <button class="btn edit-btn">Xác nhận</button>
                            </a>
                        <?php } ?>
                        <button onclick="openPopup('<?php echo $row['mahoadon']; ?>')"
                                    ...
                                    <div class="table-row">
                                        <div class="table-cell" id="products" style="display:flex">
                                            <img style="width: 80px; height: 80px;"
                                                 src="<?php echo WEBROOT . 'public/img/' . $rowctsp['hinhanh']; ?>"
                                                 alt="">
                                            <?php echo $rowctsp['tensanpham'] ?>
                                        </div>
                                        <div class="table-cell"><?php echo number_format($rowctsp['dongia'], 0, '', ','); ?>
                                            ₫
                                        </div>
