        ...
        <form method="POST" enctype="multipart/form-data" action="/inis/admin/xulysuasanpham" class="form-edit-product">
            <div class="form-container">
                ...
                <div class="form-column">
                    ...
                    <input type="text" id="edit-product-id" name="masanpham" value="<?php echo htmlspecialchars($product['masanpham']); ?>" readonly required>

                    <label for="edit-product-name">Tên sản phẩm:</label>
                    <input type="text" id="edit-product-name" name="tensanpham" value="<?php echo htmlspecialchars($product['tensanpham']); ?>" required>

                    <label for="edit-product-quantity">Số lượng:</label>
                    <input type="number" id="edit-product-quantity" name="soluong" value="<?php echo htmlspecialchars($product['soluong']); ?>" min="1" required>
                ...
                <label for="edit-product-image">Hình ảnh 1:</label>
                    ...
                    <?php if (!empty($product['hinhanh1'])): ?>
                        <img id="previewImage1" src="/public/img/<?php echo htmlspecialchars($product['hinhanh1']); ?>" alt="Xem trước ảnh 2">
                    <?php else: ?>
                    ...
                    <?php if (!empty($product['hinhanh2'])): ?>
                        <img id="previewImage2" src="/public/img/<?php echo htmlspecialchars($product['hinhanh2']); ?>" alt="Xem trước ảnh 3">
                    <?php else: ?>
                    ...
                    <?php if (!empty($product['hinhanh3'])): ?>
                        <img id="previewImage3" src="/public/img/<?php echo htmlspecialchars($product['hinhanh3']); ?>" alt="Xem trước ảnh 4">
                    <?php else: ?>
                    ...
                    <?php if (!empty($product['hinhanh4'])): ?>
                        <img id="previewImage4" src="/public/img/<?php echo htmlspecialchars($product['hinhanh4']); ?>" alt="Xem trước ảnh 5">
                    <?php else: ?>
