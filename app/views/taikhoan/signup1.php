...
<head>
    ...
    <link href="https&#x3A;&#x2F;&#x2F;pos.nvncdn.com&#x2F;cba2a3-7534&#x2F;store&#x2F;20150815_B1QOM5WqfXC02n3BPvlk82Z0.png"
...
<div class="user-wrapper">
    ...
    <form class="validate f" action="<?php echo WEBROOT . 'taikhoan/xulydangky' ?>" method="post" autocomplete="off">
        <input type="hidden" value="f312b634cadf171234f99d79a45d92b0-527bbd197dc329ee06b0b8bca6e5d31d" name="csrf"
               id="csrf"/>
        <div class="form-group">
            <input type="text" name="tenkhachhang" id="tenkhachhang"
                   class="validate[required,minSize[4],maxSize[32]] form-control"
                   placeholder="Họ tên (*)">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <input type="password" name="mat_khau_2" id="mat_khau_2"
                   class="validate[required,minSize[6],equals[password]] form-control"
