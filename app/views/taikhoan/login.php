...
<main class="main-site main-childs">
    <div class="user-wrapper">
        ...
        <form accept-charset="UTF-8" id="loginForm" class="validate" onsubmit="return validateForm()"
              action="<?php echo WEBROOT . 'taikhoan/xulydangnhap' ?>" method="post">
            <div class="form-group">
                ...
                <input type="text" name="sdt" id="sdt"
                       class="validate[required] <?php echo isset($_SESSION['loidangnhap']) ? 'input-error' : ''; ?>"
                       value="<?php
            ...
            <div class="user-foot ">
                ...
                <div class="userfoot">
                    <label for="rememberMe"><input style="  padding-left:4px;" type="checkbox" id="rememberMe"
                                                   name="rememberMe"> Nhớ mật khẩu</label>
