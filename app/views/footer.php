            ...
            <div class="footerIn">
                <a href="http://online.gov.vn/Home/WebDetails/54900?AspxAutoDetectCookieSupport=1" target="_blank"
                   class="ico_biz" style="float: right;  "><img style="width:151px; height:56px;"
                                                                ...
                                                                alt=""></a>
                <ul class="f_util">
                    <li><a href="/util?id=terms" ap-click-area="FOOTER" ap-click-name="utility"
                           ap-click-data="terms_of_service">Chính sách giao hàng và thanh toán</a></li>
                    <li><a href="/util?id=privacypolicy" ap-click-area="FOOTER" ap-click-name="utility"
                           ap-click-data="privacy_policy">Chính sách bảo mật thông tin khách hàng</a></li>
                    <li><a href="/util?id=purchase" ap-click-area="FOOTER" ap-click-name="utility"
                           ap-click-data="purchase_policy">Chính sách mua hàng</a></li>
                    <li><a href="/util?id=return" ap-click-area="FOOTER" ap-click-name="utility"
                           ap-click-data="return_policy">Chính sách trả hàng</a></li>
                </ul>
                <div class="f_cs">
                    <ul>
                        <li>Thời gian làm việc <span>Thứ 2 ~ Thứ 6 09:00 ~ 17:00 (trừ Thứ 7, Chủ Nhật và ngày lễ)</span>
                        </li>
                        <li>Tư vấn và chăm sóc khách hàng <span><a
                ...
                <div class="f_biz">
                    <ul>
                        ...
                        <li>GIẤY CNĐKDN: 0309984165 - Ngày cấp: 05/05/2010, được sửa đổi lần thứ 21, ngày 04/04/2022
                        </li>
                        <li>Cơ quan cấp: Phòng Đăng kí kinh doanh - Sở Kế hoạch và Đầu tư TP.HCM</li>
                        <li>Địa chỉ đăng ký kinh doanh: Lầu 4A, Toà nhà Vincom, 72 Lê Thánh Tôn, Phường Bến Nghé, Quận
